# Title: Delete content types by reading values from the csv file.
# Description: This script helps to delete content types by reading values from the csv file.
...
. "$currentPath\Modules\DeleteContentType.ps1"
$inputFile = $currentPath + '\Input\ContentTypesSchema.csv'
DeleteCT $inputFile $SiteCollection
